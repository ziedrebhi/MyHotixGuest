...
public class DownloadManager extends AsyncTask<String, Integer, String> {
    ...
    protected String doInBackground(String... sUrl) {
        if (isOnline()) {
            try {
                ...
                FileOutputStream output = new FileOutputStream(Environment.getExternalStorageDirectory().getPath() + "/MyHotixGuest.apk");
    ...
    public void install() {
        if (downloaded) {
            String filepath = Environment.getExternalStorageDirectory().getPath() + "/MyHotixGuest.apk";
